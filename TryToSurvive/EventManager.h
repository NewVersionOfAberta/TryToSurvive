...
enum class EventType {
	KeyDown = ttsv::Event::KeyPressed,
	KeyUp = ttsv::Event::KeyReleased,
	MButtonDown = ttsv::Event::MouseButtonPressed,
	MButtonUp = ttsv::Event::MouseButtonReleased,
	WindowResized = ttsv::Event::Resized,
	GainedFocus = ttsv::Event::GainedFocus,
	LostFocus = ttsv::Event::LostFocus,
	MouseWheel = ttsv::Event::MouseWheelScrolled,
	MouseEntered = ttsv::Event::MouseEntered,
	MouseLeft = ttsv::Event::MouseLeft,
	Closed = ttsv::Event::Closed,
	TextEntered = ttsv::Event::TextEntered,
	Keyboard = ttsv::Event::Count + 1, Mouse,
...
public:
	...
	void HandleEvent(ttsv::Event& l_event);
