...
template<class T>
inline T Interpolate(const INT32& T1, const INT32& T2, const T& T1_val, const T& T2_val, const INT32& T_X){
...
using SnapshotContainer = std::map<INT32, SnapshotDetails>;
